node {
    ...
    /*  def inst = 'cd hellonode\n git fetch --all\n git reset --hard origin/master' */
      ...
      def navss = 'cd hellonode && git checkout master && git pull origin master'
 ...
 /*def cl = 'git clone https://github.com/damukiran/hellonode.git'*/
      sshagent(['ssh_aws']) {
      sh "ssh -o StrictHostKeyChecking=no ubuntu@ec2-13-126-91-142.ap-south-1.compute.amazonaws.com ${navss}"
